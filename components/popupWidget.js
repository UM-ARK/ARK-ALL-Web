...
const PopupWidget = () => {
  ...
  return (
    <div>
      <Link href={'mailto:umacark@gmail.com'}>
        <button
          className="fixed z-40 flex items-center justify-center transition duration-300 bg-themeColor rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-themeColorLight focus:bg-themeColorLight ease">
          <span className="sr-only">Email to ARK Developer</span>
          <svg
